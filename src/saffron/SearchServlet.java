...
public class SearchServlet extends HttpServlet {
	...
	private String APIKey = YelpAPI.getAPIKEY();
	...
	private void getAPI(String term, String latitude, String longitude, String option) {
		...
		try {
			...
			URL url = new URL("https://api.yelp.com/v3/businesses/search?term=" + name + "&latitude=" + latitude
					+ "&longitude=" + longitude + "&sort_by=" + option + "&limit=10");
